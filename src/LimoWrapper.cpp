        ...
        public:
		    ...
		    auto sensor_qos = rclcpp::SensorDataQoS();
                    ...
                    lidar_sub_ = this->create_subscription<sensor_msgs::msg::PointCloud2>(
                                    config.topics.lidar, sensor_qos, std::bind(&LimoWrapper::lidar_callback, this, std::placeholders::_1), lidar_opt);
                    imu_sub_   = this->create_subscription<sensor_msgs::msg::Imu>(
                                    config.topics.imu, sensor_qos, std::bind(&LimoWrapper::imu_callback, this, std::placeholders::_1), imu_opt);
